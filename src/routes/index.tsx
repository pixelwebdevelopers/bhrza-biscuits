  ...
  head: () => ({
    meta: [
      { title: "BHRZA Biscuits — Made for Every Moment" },
      {
        name: "description",
        content:
          "Discover BHRZA Biscuits, proudly made by NKT Food's Pvt Ltd. in Nowshera, KPK, Pakistan.",
      },
      { property: "og:title", content: "BHRZA Biscuits — Made for Every Moment" },
      {
        property: "og:description",
        content: "Pakistani biscuits for tea time, family moments and everyday enjoyment.",
      },
        ...
        <div className="site-container relative z-10 flex min-h-[calc(100svh-5rem)] items-center py-16">
          <div className="max-w-2xl text-hero-foreground">
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-hero-muted md:text-xl">
              Discover the delicious taste of BHRZA Biscuits, proudly made in Pakistan.
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <Button asChild size="lg" variant="hero">
                <Link to="/products">
                  Explore Our Biscuits <ArrowRight />
                </Link>
              </Button>
        ...
        <div className="site-container grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <p className="section-copy">
              BHRZA brings together the simple pleasure of biscuits with a focus on creating treats
              families can enjoy every day. From quiet tea breaks to lively gatherings, every plate
              is an invitation to pause and share.
            </p>
      ...
      <section className="section-block bg-cream">
        <div className="site-container">
          <div className="section-heading-row">
            <div>
              <p className="eyebrow">Our Biscuit Collection</p>
              <h2 className="section-title">Find Your Favourite</h2>
            </div>
            <p className="demo-note">
              Freshly baked with quality ingredients for the perfect teatime crunch.
            </p>
          </div>
              ...
              <article key={product.name} className="product-card">
                <div className="product-image">
                  <img
                    ...
                    className={`h-full w-full object-cover ${product.position}`}
                    loading="lazy"
                    width={1600}
                    height={1200}
                  />
                  <span className="demo-badge">{product.tag}</span>
                </div>
                <div className="p-6">
      ...
      <section className="section-block bg-background">
        <div className="site-container">
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-lg bg-border sm:grid-cols-2 lg:grid-cols-4">
            {[
              [MapPin, "Made in Pakistan", "Proudly manufactured in Nowshera, KPK."],
              [Sparkles, "Quality Focused", "Thoughtfully produced for everyday enjoyment."],
              [
                Heart,
                "Made for Sharing",
                "Biscuits for tea time, family moments and everyday cravings.",
              ],
              [Sun, "Easy to Enjoy", "A simple treat for every occasion."],
            ].map(([Icon, title, text]) => {
      ...
      <section className="section-block bg-cream">
        <div className="site-container grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <div>
            ...
            <p className="section-copy">
              BHRZA Biscuits is manufactured by NKT Food's Pvt Ltd. at Main GT Road, Nowshera, KPK,
              Pakistan.
            </p>
      ...
      <section className="quality-strip">
        <div className="site-container">
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Symbols shown reflect the packaging information provided for this website.
          </p>
        </div>
      </section>
      ...
      <section className="section-block bg-background">
        <div className="site-container grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="image-frame aspect-square lg:aspect-[4/3]">
            <img
              src={heroImage}
              alt="Pakistani chai served alongside several biscuit varieties"
              className="h-full w-full object-cover object-right"
              loading="lazy"
              width={1920}
              height={1088}
          ...
          <div>
            ...
            <p className="section-copy">
              A warm cup, a generous plate, and time to reconnect. The biscuit varieties pictured
              are serving inspiration and do not represent a confirmed BHRZA product range.
            </p>
            <div className="mt-7 flex items-center gap-3 text-sm font-bold text-primary">
              <Wheat /> Serve. Share. Enjoy.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-block bg-cream">
        <div className="site-container grid items-center gap-10 md:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="section-copy">
              Follow BHRZA Biscuits on Facebook for brand updates and everyday inspiration.
            </p>
          </div>
        ...
        <div className="site-container grid gap-12 py-16 lg:grid-cols-[0.8fr_1.2fr] lg:py-20">
          <div>
            ...
            <p className="mt-5 max-w-md leading-7 text-primary-soft">
              Have a question about BHRZA Biscuits? Get in touch with our team.
            </p>
            <a
